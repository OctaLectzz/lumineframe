export default {
  ...
  auth: {
    welcomeMsg: 'Bienvenido a LuminaFrame',
    ...
    permissionText1: 'Al continuar, acepta los términos de LuminaFrame',
    permissionText2: 'y reconoce que ha leído nuestros',
    loginRedirect: '¿Ya eres miembro? Iniciar sesión',
    registerRedirect: '¿Todavía no estás en LuminaFrame? Registrarse',
