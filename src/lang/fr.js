export default {
  ...
  auth: {
    welcomeMsg: 'Bienvenue sur LuminaFrame',
    ...
    permissionText1: 'En continuant, vous acceptez les conditions de LuminaFrame',
    permissionText2: 'et reconnaissez avoir lu nos',
    loginRedirect: 'Déjà membre ? Se connecter',
    registerRedirect: "Pas encore sur LuminaFrame ? S'inscrire",
