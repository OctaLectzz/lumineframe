export default {
  ...
  auth: {
    welcomeMsg: 'ยินดีต้อนรับสู่ LuminaFrame',
    firstNameForm: 'ชื่อ',
    ...
    permissionText1: 'ดำเนินการต่อแสดงว่าคุณยินยอมกับข้อกำหนดของ LuminaFrame',
    permissionText2: 'และยอมรับว่าคุณได้อ่านของเรา',
    loginRedirect: 'เป็นสมาชิกอยู่แล้ว? เข้าสู่ระบบ',
    registerRedirect: 'ยังไม่ได้เป็นสมาชิก LuminaFrame หรือ? สมัครสมาชิก',
